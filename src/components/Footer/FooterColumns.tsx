...
type FooterColumnIconPropsType = {
    socialIcon?: string
    paymentIcon?: string
    appIcon?: string
}

type FooterColumnsPropsType = MapStateToPropsType & MapDispatchToPropsType & OwnPropsType
...
const FooterColumnIcon: FC<FooterColumnIconPropsType> = ({socialIcon, paymentIcon, appIcon}) => {
    return (
        <>
            {
                (socialIcon || appIcon) &&
...
const FooterColumns: FC<FooterColumnsPropsType> = ({footer}) => {
...
export default connect<MapStateToPropsType, MapDispatchToPropsType, OwnPropsType, AppStateType>(mstp, mdtp)(FooterColumns);
